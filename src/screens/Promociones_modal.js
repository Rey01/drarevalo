...
export default class Promociones_modal extends React.Component {
  state = {
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          >
            ...
            <Text>No onPress handler. will not dismiss when touch overlay.</Text>
          </ModalContent>
        </Modal>
        ...
        <Modal.BottomModal
          ...
          onPress={() => this.setState({ bottomModal: false })}
          // modalStyle={{  }}
        >
          <ModalContent
            style={{
